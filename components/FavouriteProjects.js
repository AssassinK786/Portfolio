    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://github.com/AssassinK786/V.I.E.H-Hybrid-Encryptor"
            className="w-full block col-span-3 shadow-2xl"
          >
            <div className="relative overflow-hidden">
              <img
                src="/VIEH Hybrid Encryptor.png"
                alt="portfolio"
                className="transform hover:scale-125 transition duration-2000 ease-out"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
              V.I.E.H Hybrid Encryptor
              </h1>
          ...
          {/* Single card */}
          <a
            href="https://github.com/nishchay-0730/Multi-VLAN-Design-over-IPsec-VPN-for-Campus-Network"
          ...
          >
            <div className="relative overflow-hidden">
              ...
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">
              Multi-VLAN-Design-over-IPsec-VPN-for-Campus-Network
              </h1>
              <h1 className="absolute bottom-10 left-10 text-gray-50 font-bold text-xl">
                02
              </h1>
